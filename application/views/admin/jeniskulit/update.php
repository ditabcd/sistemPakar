    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Ubah Jenis Kulit</h4>
            </div>
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="text" name="jenis_kulit" class="form-control" placeholder="jenis_kulit" value="<?php echo $jenis_kulit_data->jenis_kulit ?>">
